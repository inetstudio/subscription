...
use InetStudio\Subscription\Contracts\Events\Front\EmailUnsubscribedEventContract;

/**
 * Class EmailUnsubscribedEvent.
 */
class EmailUnsubscribedEvent implements EmailUnsubscribedEventContract
{
